...
export const $rawShots = createSelector($i, (state: IIsoStore) => state.shots); // prettier-ignore
export const $rawControl = createSelector($i, (state: IIsoStore) => state.control); // prettier-ignore
