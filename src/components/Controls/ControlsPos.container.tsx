...
export type ControlsPosContainerProps = {};

export function ControlsPosContainer(props: ControlsPosContainerProps) {
  ...
  const dot = useSelector(selectors.singles.$dotCurrent);
...
export default ControlsPosContainer;
