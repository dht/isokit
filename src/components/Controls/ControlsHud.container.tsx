...
import { hudInputs, positionInputs } from './Controls.data';
import { invokeEvent } from 'shared-base';

export type ControlsHudContainerProps = {};

export function ControlsHudContainer(props: ControlsHudContainerProps) {
  ...
  const inputs = useMemo(() => {
    return hudInputs.filter((input: Json) => {
...
export default ControlsHudContainer;
