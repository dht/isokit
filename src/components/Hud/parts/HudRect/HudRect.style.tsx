...
export const Wrapper = styled.g`
    ...
    .rect-top-right {
        animation: dashTopRight 1s linear forwards;
    }

    .rect-top-left {
        animation: dashTopLeft 1s linear forwards;
    }

    .rect-bottom-right {
        animation: dashBottomRight 1s linear forwards;
    }

    .rect-bottom-left {
        animation: dashBottomLeft 1s linear forwards;
    }
